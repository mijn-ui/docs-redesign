...
export const Icons = {
  ...
  tailwind: (props: IconProps) => (
    <svg
      className={cnBase("text-sky-600 dark:text-sky-500", props.className)}
      fill="currentColor"
      height={18}
      stroke="currentColor"
      strokeWidth={0}
  ...
  react: (props: IconProps) => (
    <svg
      className={cnBase("text-[#0058cc]", props.className)}
      fill="currentColor"
      height={18}
      stroke="currentColor"
      strokeWidth={0}
  ...
  laravel: (props: IconProps) => (
    <svg
      className={cnBase("text-[#F05340]", props.className)}
      fill="currentColor"
      height={18}
      stroke="currentColor"
      strokeWidth={0}
