...
export const TemplateGroups: Array<TechnologyGroup> = ["react", "tailwind", "laravel"] as const
    ...
    items: [
      {
        ...
        status: "beta",
        description: "A template for creating a chatbot that can answer questions using a knowledge base.",
        cover: {
      ...
      },
      {
        ...
        name: "ERP Template",
        status: "beta",
        description: "A template for creating a point of sale system for an ERP application.",
        cover: {
        ...
        technologies: ["Next.js v15", "React.js v19", "next-themes v0.4", "mijn-ui v0.1.0"],
      ...
      },
      {
        ...
        technologies: ["next.js", "next-auth v5", "next-themes v0.4", "react-hook-form v7", "mijn-ui v0.1.0"],
