...
const BadgeOverride = () => (
  <Badge
    className="cursor-pointer rounded-full bg-gradient-to-r from-primary/20 via-primary/70 to-primary/20 px-2 py-0.5 font-semibold text-tiny transition-shadow duration-300 hover:shadow-large hover:shadow-primary/20 hover:brightness-105 active:scale-95 active:brightness-90 dark:via-primary/40 dark:to-primary/20"
    unstyled
  >
    Custom Badge
  </Badge>
