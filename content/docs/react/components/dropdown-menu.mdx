...
<ComponentPreview type="react" name="dropdown-menu-example" />
    ...
    <Steps>
      ...
      <Step>
        **Copy and paste the following code into your project**
        ...
        <ReactSourceCodeDisplay path="packages/components/dropdown-menu/src/dropdown-menu.tsx" />
      </Step>
    </Steps>
...
<ComponentPreview type="react" name="dropdown-menu-checkboxes" />

### Radio Group

<ComponentPreview type="react" name="dropdown-menu-radio-group" />
