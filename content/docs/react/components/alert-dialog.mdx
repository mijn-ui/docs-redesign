...
<ComponentPreview type="react" name="alert-dialog-example" />
  ...
  <Steps>
    ...
    <Step>
      **Copy and paste the following code into your project**
      ...
      <ReactSourceCodeDisplay path="packages/components/alert-dialog/src/alert-dialog.tsx" />
    </Step>
...
<ComponentPreview type="react" name="alert-dialog-danger" />

### Alert Dialog Success

<ComponentPreview type="react" name="alert-dialog-success" />

### Alert Dialog Warning

<ComponentPreview type="react" name="alert-dialog-warning" />

### Alert Dialog Newsletter

<ComponentPreview type="react" name="alert-dialog-newsletter" />
