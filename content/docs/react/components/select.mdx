...
<ComponentPreview type="react" name="select-example" />
    ...
    <Steps>
      ...
      <Step>
        **Copy and paste the following code into your project**
        ...
        <ReactSourceCodeDisplay path="packages/components/select/src/select.tsx" />
      </Step>
    </Steps>
...
<ComponentPreview type="react" name="select-scrollable" />
